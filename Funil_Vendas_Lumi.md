...
| [Desler AI](https://desler.com.br/)³ (achado 08/09/2026) | R$ 198/mês | R$ 298/mês | Sob consulta | sem taxa (declarado); "migração VIP gratuita" do sistema antigo sugere onboarding leve |
...
³ Mesma categoria da Densya, não concorrente direto puro: Desler é sistema de gestão completo (agenda, financeiro, CRM, prontuário eletrônico, DRE) pra **médicos e dentistas** — a IA é um módulo dentro do sistema, e usar exige trocar de sistema de gestão inteiro (eles fazem a migração de dados). Cobra por **acesso simultâneo**, não por clínica (+R$79-150/mês por acesso adicional) e tem **teto de 400 conversas de WhatsApp/mês por acesso** (IA ou não) — a Lumi não tem teto. Já tem algo equivalente ao nosso funil de resgate ("oferta de novo agendamento se paciente faltou ou cancelou") e uma máquina de conteúdo/blog já rodando (LGPD na saúde, redução de no-show, WhatsApp Business pra clínicas — confirma que os termos de SEO já mapeados fazem sentido).
...
**Achado 08/09/2026 (Desler AI)**: preço deles (R$198-298/mês) é um terço do nosso, mas é categoria diferente — sistema de gestão completo que exige trocar de sistema pra usar a IA, não um complemento que entra por cima do que a clínica já tem. **Não é motivo pra baixar preço** (competir na régua deles é competir pela escala de SaaS genérico, que a gente não tem); é confirmação de que **"não substitui seu sistema" é o wedge mais afiado que temos contra esse tipo de concorrente especificamente** — vale reforçar essa mensagem no site com mais destaque. Também confirma que a estratégia de conteúdo/SEO já desenhada (`Log_Progresso_Comercializacao.md`, 07/09) está mirando nos termos certos — eles já têm um blog rodando nos mesmos temas.
