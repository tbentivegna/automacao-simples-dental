module.exports = {
  ...
  descricao:
    'Reproduz o caso real que falhou em produção: o paciente já tem uma consulta marcada ' +
    '(seed) e, sem a Lumi ter perguntado nada sobre lembrete nesta conversa, ele mesmo pede ' +
    'pra confirmar/ativar o consentimento. A Lumi precisa tratar isso como a resposta em si ' +
    'e chamar a ferramenta Registrar Consentimento Lembrete -- nunca dizer que "já está ' +
